...
This is intentional. The author of a function can use any variable names they like without risking interference with names in the calling code, and callers do not need to know about the internal names a function uses.
