...
When a program grows beyond a few dozen lines, keeping track of every detail becomes impractical. 
Just as variables make it easier to reuse values throughout your code, Functions make it easier to reuse
`methods' throughout your code. Functions let you bundle a piece of logic/code with a name, then use that name
throughout your code when you want to use that bundle of. A well-named function also makes code dramatically 
easier to read, and it enables re-use.
