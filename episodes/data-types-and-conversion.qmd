...
The *variable* is just a label — it is the *value* that carries the type. This lesson focuses on what each type allows you to do, and how to convert between them.

A value's type determines which operations make sense. Arithmetic subtraction works on numbers but not on strings:
