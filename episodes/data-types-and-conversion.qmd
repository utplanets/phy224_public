...
The *variable* is just a label — it is the *value* that carries the type. A value's type determines which operations make sense. For example, arithmetic subtraction works on numbers but not on strings:
