...
- Use `scipy.integrate.trapezoid` to integrate tabular data.
...
x = numpy.arange(11)
y = x ** 2
print("integral of x² from 0 to 10 (coarse grid):", scipy.integrate.trapezoid(y))
```
...
y = x ** 2
print("integral with fine grid and x values:", scipy.integrate.trapezoid(y, x))
```
...
- Use `scipy.integrate.trapezoid(y, x)` to integrate tabular data numerically.
