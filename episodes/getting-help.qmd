...
3. **Read any keyword arguments you do not recognise.** A line like `numpy.loadtxt(f, delimiter=',', usecols=(0,2))` has three arguments: look up `usecols` if you have not seen it before. Copying code without understanding its arguments leads to silent bugs.
