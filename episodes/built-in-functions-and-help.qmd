...
The general strategy: fix syntax errors by reading the source code carefully around the `^` marker; fix runtime errors by tracing what value each variable holds when the error line is reached.
